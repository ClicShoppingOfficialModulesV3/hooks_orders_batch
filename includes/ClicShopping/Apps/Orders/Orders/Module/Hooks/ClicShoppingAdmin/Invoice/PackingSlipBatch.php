<?php
  ...
  class PackingSlipBatch implements \ClicShopping\OM\Modules\HooksInterface
  {
    protected $app;
    ...
    public function execute()
    {
      ...
      $output = '&nbsp;';
      $output .= '
                  <a data-toggle="modal" data-target="#myModalPackingSlipOrder">' . HTML::button($this->app->getDef('button_packingslip_batch'), null, null, 'info') . '</a>
                   <div class="modal fade" id="myModalPackingSlipOrder" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                     <div class="modal-dialog">
                       <div class="modal-content">
                         <div class="modal-header">
                           <h4 class="modal-title text-start" id="myModalLabel">' . $this->app->getDef('packingslip_batch_heading') . '</h4>
                         </div>
                         <div class="modal-body text-center">
                           ' . HTML::form('packingslip_batch', $this->app->link('PackingSlipBatch')) . '
                           <div class="col-md-12">
